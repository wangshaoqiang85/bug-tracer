# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2020-08-04 12:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='文件/文件夹', max_length=128, verbose_name='文件名称')),
                ('key', models.CharField(blank=True, max_length=256, null=True, verbose_name='文件存储在COS中key')),
