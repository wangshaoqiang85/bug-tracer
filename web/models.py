...
class PricePolicy(models.Model):
    ...
    category = models.SmallIntegerField(verbose_name='收费策略', default=2, choices=category_choices)
    title = models.CharField(verbose_name='标题', max_length=32)
    price = models.PositiveIntegerField(verbose_name='价格')  # 正整数

    project_num = models.PositiveIntegerField(verbose_name='项目数')
    project_member = models.PositiveIntegerField(verbose_name='单个项目成员数')
    project_space = models.PositiveIntegerField(verbose_name='单项目空间', help_text='MB')
...
class Project(models.Model):
    ...
    region = models.CharField(verbose_name='COS区域', max_length=32, default='')
...
class FileRepository(models.Model):
    ...
    name = models.CharField(verbose_name='文件名称', max_length=128, help_text='文件/文件夹')
    key = models.CharField(verbose_name='文件存储在COS中名称', max_length=256, null=True, blank=True)
